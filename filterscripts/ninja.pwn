...
GameTextForPlayer(playerid,"~r~Khong Duoc Chay Nhanh De Len Xe \r\n~w~De Phong Chong Ninja",5000,4);
IsPlayerSteppingInVehicle[playerid] = -1;
GetPlayerName(playerid,pName,28);
format(string,sizeof string,"%s(%i) dang su dung NiNja!",pName,playerid);
print(string);
}
}
}
